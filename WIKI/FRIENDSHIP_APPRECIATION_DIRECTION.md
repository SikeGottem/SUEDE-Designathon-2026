...
The supporting hypotheses are that visible effort signals sincerity, sincere care should be reciprocated, and emotional directness needs a socially recognised container.

## Problem

The appreciation often already exists. The likely problem is that people lack a socially comfortable way to express it so that it feels deliberate and lands as lasting evidence of care.

The team currently sees a format gap:

- Ordinary chat is easy, but appreciation sits beside disposable conversation, gets buried and carries little visible effort.
...
- Friendship appreciation is the working problem direction.
- The difficult moment is deciding to express care, choosing a meaningful channel and anticipating how it will be interpreted.
...
- Does this behaviour recur outside the team, and for which friendships?
- Can digital feel as personal and ownable as physical without imitating it superficially?
- Does the experience reduce ambiguity and reply pressure, or intensify both?
- What mechanism changes the social rule rather than only making a prettier message?
