...
- **Current source cut:** 30 transcript captures, the conceptual spec, supplied product wireframes, the white/navy `warm & fuzzies` visual reference, and the earlier handwriting/palette references.
...
| `studio-paper-sheet` | flexible mobile sheet boundary | resting, editing | One quiet paper surface for making. It should hold writing and placed materials without looking like stacked cards. |
| `material-rail-edge` | flexible / optional | resting, scrollable | A compact cue that the material rail continues to scroll; never an oversized button wall. |
...
| Make the inside | Words, photo, voice, song, and drawing marks sit irregularly on one mobile white paper sheet; a compact material rail can scroll as more pieces are available. Removal and focus states stay clear. |
...
4. **44–54 min — core maker/living-page marks:** paper-sheet edge, compact scrollable material rail cue, photo, voice/playback, song, drawing/personal-mark, connector line.
...
- [ ] Studio assets support one paper-sheet surface and a compact scrollable material rail at phone width.
